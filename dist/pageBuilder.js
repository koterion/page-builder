...
function () {
  ...
  _createClass(PageBuilder, [{
    ...
    value: function _createRowMenu(row) {
      ...
      var _ref3 = [this._createEl('button', {
    ...
    value: function _addColFunc(col) {
      ...
      if (this.options.edit) {
        ...
        var setting = this._createEl('button', {
    ...
    value: function _createColSettings(column) {
      ...
      var _ref4 = [_this._createEl('div', {
        ...
        title: 'Close',
        type: 'button'
      }, "<i class=\"svg\"></i> <span>Exit</span>"), _this._createEl('button', {
        "class": className + '-save',
        title: 'Save',
        type: 'button'
...
__webpack_require__(/*! C:\Users\Admin\Desktop\plugins\page_builder\src\js\pageBuilder.js */"./src/js/pageBuilder.js");
__webpack_require__(/*! C:\Users\Admin\Desktop\plugins\page_builder\src\sass\pageBuilder.sass */"./src/sass/pageBuilder.sass");
__webpack_require__(/*! C:\Users\Admin\Desktop\plugins\page_builder\src\sass\theme\voyager.sass */"./src/sass/theme/voyager.sass");
module.exports = __webpack_require__(/*! C:\Users\Admin\Desktop\plugins\page_builder\src\sass\main.sass */"./src/sass/main.sass");
